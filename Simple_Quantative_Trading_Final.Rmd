...
doji_CO <- data.frame(ifelse(abs(Three_Stock_df$CL.F.Close - Three_Stock_df$CL.F.Open) < 0.45, "yes", "no"))    
...
doji_SP <- data.frame(ifelse(abs(Three_Stock_df$GSPC.Close - Three_Stock_df$GSPC.Open) < 45, "yes", "no"))  
...
doji_shell <- data.frame(ifelse(abs(Three_Stock_df$SHEL.Close - Three_Stock_df$SHEL.Open) < 0.45, "yes", "no")) 
...
plot(Three_Stock_df$CL.F.Close[(21 + trainRange), ], main = "Train Range")
plot(Three_Stock_df$CL.F.Close[(21 + testRange), ], main = "Test Range")
